...
class SafeDatabaseManager:
        ...
        try:
            with sqlite3.connect(self.db_path, timeout=5.0) as conn:
                ...
                required_cache_columns = {
                    'id', 'query', 'query_hash', 'command', 'confidence_score',
    ...
    def get_database_stats(self):
        ...
        try:
            ...
            stats['cache_entries'] = result[0][0] if result and isinstance(result, list) and len(result) > 0 else 0
            ...
            stats['feedback_entries'] = result[0][0] if result and isinstance(result, list) and len(result) > 0 else 0
